...
export const DEMO_ADMIN_QUESTIONS = [
  { id: 'aq-1', subject: 'maths', topic_title: 'Place value', question: 'Write 2,306 in words.', answer: 'Two thousand three hundred and six', marks: 1, question_number: 1, month: 'August', day: 29, difficulty: 'easy', skill_type: 'retrieval', solution_steps: 'Split into thousands, hundreds, tens and ones.', hints: 'Say each place-value chunk separately.' },
  { id: 'aq-2', subject: 'maths', topic_title: 'Rounding', question: 'Round 4,781 to the nearest 100.', answer: '4800', marks: 1, question_number: 2, month: 'August', day: 29, difficulty: 'easy', skill_type: 'fluency', solution_steps: 'The tens digit is 8, so round up.', hints: 'Look at the digit to the right of the hundreds.' },
  { id: 'aq-3', subject: 'maths', topic_title: 'Quadratic Equations', question: 'Factorise x² + 7x + 12.', answer: '(x + 3)(x + 4)', marks: 2, question_number: 3, month: 'August', day: 29, difficulty: 'medium', skill_type: 'reasoning', solution_steps: 'Find two numbers that multiply to 12 and add to 7.', hints: 'What multiplies to 12?' },
  { id: 'aq-4', subject: 'economics', topic_title: 'Demand', question: 'What happens to quantity demanded when price rises, ceteris paribus?', answer: 'It falls', marks: 1, question_number: 1, month: 'August', day: 29, difficulty: 'easy', skill_type: 'retrieval', solution_steps: 'Movement along the demand curve.', hints: 'Think contraction, not a shift.' },
  { id: 'aq-5', subject: 'economics', topic_title: 'Elasticity', question: 'State what price elasticity of demand measures.', answer: 'The responsiveness of quantity demanded to a change in price', marks: 2, question_number: 2, month: 'August', day: 29, difficulty: 'medium', skill_type: 'application', solution_steps: 'Link a price change to the response in quantity demanded.', hints: 'Use the word responsiveness.' },
];
